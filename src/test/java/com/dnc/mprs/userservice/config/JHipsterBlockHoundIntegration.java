...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.dnc.mprs.userservice.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.dnc.mprs.userservice.security.DomainUserDetailsService", "createSpringSecurityUser");
